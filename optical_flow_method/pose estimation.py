...
def calculate_speed(flow, scale_factor, fps):
    ...
    """
    magnitudes = np.sqrt(flow[..., 0] ** 2 + flow[..., 1] ** 2)  # Corrected magnitude formula
...
if __name__ == "__main__":
    video_path = r"C:\Users\hp\Desktop\github_cv\pose_estimation\1.mp4"
    scale_factor = 0.05  # Meters per pixel (approximate)
    fps = 30
