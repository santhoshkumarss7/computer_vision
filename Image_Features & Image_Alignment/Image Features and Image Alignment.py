...
# Load image 
img = cv2.imread(r"C:\Users\DELL\Desktop\github_cv\Image_Features & Image_Alignment\original.jpg", cv2.IMREAD_COLOR) 
...
cv2.imshow("Fourier Magnitude Spectrum", np.uint8(magnitude_spectrum / 
np.max(magnitude_spectrum) * 255)) 
